# Лабораторная работа 1 - Начинаем работать с Watson Studio
...
Типичная работа data scientist предполагает построение моделей (кодирование) на Python, R или Scala. Далее, мы ознакомимся с типичным Jupyter Notebook на Python.
